	...
	<fieldset>
		<legend><?php echo (__('Input information customer contact')); ?></legend>
	</fieldset>

	<div class="row" style="margin: 0px 20px 20px ;">
	...
	<fieldset>
		<legend><?php echo (__('Choose products order for customer contact')); ?></legend>
	</fieldset>
					...
					<tbody id="cart">
						...
						<?php 
							...
							<tr>
								...
								<td>
									<a href="<?php echo $this->request->webroot . 'admin/orders/removeCart/'. $value['product_id'];  ?>" onclick="checkDelete(event)">
