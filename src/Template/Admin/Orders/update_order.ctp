<fieldset>
	...
	<legend><?php echo (__('Update order cart')); ?></legend>
				...
				<tbody id="cart">
					<?php
						...
						<tr>
							...
							<!-- <td>
								<a href="<?php echo $this->request->webroot . 'admin/orders/deleteCartUpdate/'. $value['product_id'];  ?>" onclick="checkDelete(event)">
